...
// E1: typy przeciwników
public enum EnemyType
{
    Grunt,   // podstawowy
    Fast,    // szybki – mało HP, duża prędkość
    Tank,    // powolny – dużo HP, wysoka nagroda
    Flying   // latający – ignoruje ścieżkę naziemną, leci prosto
}

public sealed class Enemy
{
    public EnemyType Type;   // E1: typ przeciwnika
    public float Hp;
    public float MaxHp;
    public float Speed;
    public Vector2 Pos;
